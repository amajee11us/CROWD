...
from .submod_selection.GCCG import GraphCutConditionalGain
...
def filter_submod_selection(labels_img, boxes_img, feats_img, cls_img, obj_img, num_proposals):
    """
    ...
    if known_idx.numel() > 0 and unknown_idx.numel() > 0:
        ...
        # Submod selection
        obj_cg_background = GraphCutConditionalGain(feats_img, 
                                                   known_feats, 
                                                   similarity_fn, 
                                                   lamda = 0.5, 
                                                   nu = 5.0)
        ...
        obj_cg_unknown = GraphCutConditionalGain(feats_img, 
                                                 feats_known_and_background, 
                                                 similarity_fn, 
                                                 lamda = 0.5, 
                                                 nu = 2.5)
