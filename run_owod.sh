...
if [ $BENCHMARK == "M-OWODB" ]; then
  ...
  CUDA_VISIBLE_DEVICES=${GPUS} python discover_unknown.py \
                                ...
                                --task ${BENCHMARK}/t1 \
                                --output output/baseline_FLCG/${BENCHMARK}/t1/unknown_rois.json \
                                --opts MODEL.WEIGHTS output/baseline_FLCG/${BENCHMARK}/t1/model_0009999.pth DISCOVER_UNKNOWN True
  ...
  CUDA_VISIBLE_DEVICES=${GPUS} python train_net.py \
                                ...
                                --config-file configs/${BENCHMARK}/t1_ft.yaml \
                                --resume \
                                MODEL.WEIGHTS output/baseline_FLCG/${BENCHMARK}/t1/model_0009999.pth \
                                DISCOVER_STORE_PATH output/baseline_FLCG/${BENCHMARK}/t1/unknown_rois.json
  ...
  CUDA_VISIBLE_DEVICES=${GPUS} python train_net.py \
                                ...
                                MODEL.WEIGHTS output/baseline_FLCG/${BENCHMARK}/t1/model_0019999.pth
  
  CUDA_VISIBLE_DEVICES=${GPUS} python discover_unknown.py \
                                --config-file configs/${BENCHMARK}/t2_ft.yaml \
                                --input-txt datasets/ImageSets/Main/${BENCHMARK}/t2_ft.txt \
                                --task ${BENCHMARK}/t2_ft \
                                --output output/baseline_FLCG/${BENCHMARK}/t2/unknown_rois.json \
                                --opts MODEL.WEIGHTS output/baseline_FLCG/${BENCHMARK}/t2/model_0014999.pth DISCOVER_UNKNOWN True
  ...
  CUDA_VISIBLE_DEVICES=${GPUS} python train_net.py \
                                ...
                                --config-file configs/${BENCHMARK}/t2_ft.yaml \
                                --resume \
                                MODEL.WEIGHTS output/baseline_FLCG/${BENCHMARK}/t2/model_0014999.pth \
                                DISCOVER_STORE_PATH output/baseline_FLCG/${BENCHMARK}/t2/unknown_rois.json
